    ...
    return (
        <footer className="bg-red-900 text-white w-full">
            <div className="relative w-full h-full">
                <div className="absolute z-10 inset-0 bg-gradient-to-b from-transparent to-red-900 h-full w-full" />
                <span
                    className={`${DisplayBebasNeue.className} font-black absolute inset-0 flex items-center justify-center pointer-events-none overflow-hidden`}
                    style={{
