...
export default function formInputTextBox({type, question, value, onChange}: FormInputTextBoxProp) {
    ...
    return (
        <div className="w-full p-5 flex flex-col gap-2">
            ...
            <input type="text" value={value ?? ""} onChange={e => onChange(e.target.value)} placeholder="Please enter here..." className="w-full border-1 focus:border-dark-maroon focus:border-2 p-2"/>
        </div>
    )
}